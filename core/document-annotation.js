 ...
 */
export const documentAnnotationContractVersion = 'deskreview_document_annotation_v17';
      ...
      properties: {
        front_matter: {
          ...
          properties: {
            ...
            affiliations: { type: 'array', description: 'Every complete visible institutional affiliation as one separate item, including affiliations printed later in a dedicated Affiliations section. Read the entire affiliation run before returning: when entries carry superscript, numeric, or letter markers, return one item for every complete labelled statement in printed order, including the final entry. Split semicolon-separated complete affiliations. Exclude markers alone, author superscript groups, correspondence lines, contribution initials, and abbreviations. If only author superscripts are visible but complete institutional statements are absent, return an empty array.', items: sourceItem },
