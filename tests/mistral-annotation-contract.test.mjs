...
assert.equal(documentAnnotationContractVersion, 'deskreview_document_annotation_v17');
...
assert.match(documentAnnotationFormat.json_schema.schema.properties.front_matter.properties.affiliations.description, /entire affiliation run/);
assert.match(documentAnnotationFormat.json_schema.schema.properties.front_matter.properties.affiliations.description, /final entry/);
